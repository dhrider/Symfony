...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // oc_platform_purger
        if (preg_match('#^/(?P<_locale>en|fr)/platform/purger/(?P<days>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'oc_platform_purger')), array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::purgerAction',));
        }
        ...
        if (0 === strpos($pathinfo, '/log')) {
            if (0 === strpos($pathinfo, '/login')) {
                ...
                if ($pathinfo === '/login') {
                    ...
                    return array (  '_controller' => 'OC\\UserBundle\\Controller\\SecurityController::loginAction',  '_route' => 'fos_user_security_login',);
                }
                ...
                if ($pathinfo === '/login_check') {
                    ...
                    return array (  '_controller' => 'OC\\UserBundle\\Controller\\SecurityController::checkAction',  '_route' => 'fos_user_security_check',);
                }
            ...
            if ($pathinfo === '/logout') {
                ...
                return array (  '_controller' => 'OC\\UserBundle\\Controller\\SecurityController::logoutAction',  '_route' => 'fos_user_security_logout',);
            }
