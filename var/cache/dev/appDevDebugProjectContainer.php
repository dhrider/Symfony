...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'oc_platform.beta.html_adder' => 'getOcPlatform_Beta_HtmlAdderService',
            'oc_platform.beta.listener' => 'getOcPlatform_Beta_ListenerService',
            'oc_platform.bigbrother.message_listener' => 'getOcPlatform_Bigbrother_MessageListenerService',
            'oc_platform.bigbrother.message_notificator' => 'getOcPlatform_Bigbrother_MessageNotificatorService',
            'oc_platform.doctrine_listener.application_creation' => 'getOcPlatform_DoctrineListener_ApplicationCreationService',
            'oc_platform.email.application_mailer' => 'getOcPlatform_Email_ApplicationMailerService',
            'oc_platform.form.ckeditor' => 'getOcPlatform_Form_CkeditorService',
            'oc_platform.purger.advert' => 'getOcPlatform_Purger_AdvertService',
            'oc_platform.twig.antispam_extension' => 'getOcPlatform_Twig_AntispamExtensionService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'oc_platform.beta.listener', 1 => 'processBeta'), 0);
        $instance->addListenerService('oc_platform.post_message', array(0 => 'oc_platform.bigbrother.message_listener', 1 => 'processMessage'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventListener(array(0 => 'postPersist'), $this->get('oc_platform.doctrine_listener.application_creation'));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\OC\\PlatformBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\OC\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'OC\\PlatformBundle\\Entity');
        $c->addDriver($b, 'OC\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('OCPlatformBundle' => 'OC\\PlatformBundle\\Entity', 'OCUserBundle' => 'OC\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9f02647a739e5e71a13b7908fc7a24b51ea1312a9d1641351fdcd48601e3f713');
    ...
    {
        $this->services['oc_platform.antispam'] = $instance = new \OC\PlatformBundle\Antispam\OCAntispam($this->get('swiftmailer.mailer.default'), 50);
    ...
    /**
     * Gets the 'oc_platform.beta.html_adder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Beta\BetaHTMLAdder A OC\PlatformBundle\Beta\BetaHTMLAdder instance.
     */
    protected function getOcPlatform_Beta_HtmlAdderService()
    {
        return $this->services['oc_platform.beta.html_adder'] = new \OC\PlatformBundle\Beta\BetaHTMLAdder();
    }

    /**
     * Gets the 'oc_platform.beta.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Beta\BetaListener A OC\PlatformBundle\Beta\BetaListener instance.
     */
    protected function getOcPlatform_Beta_ListenerService()
    {
        return $this->services['oc_platform.beta.listener'] = new \OC\PlatformBundle\Beta\BetaListener($this->get('oc_platform.beta.html_adder'), '2017-06-01');
    }

    /**
     * Gets the 'oc_platform.bigbrother.message_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Bigbrother\MessageListener A OC\PlatformBundle\Bigbrother\MessageListener instance.
     */
    protected function getOcPlatform_Bigbrother_MessageListenerService()
    {
        return $this->services['oc_platform.bigbrother.message_listener'] = new \OC\PlatformBundle\Bigbrother\MessageListener($this->get('oc_platform.bigbrother.message_notificator'), array(0 => 'alexandre', 1 => 'marine', 2 => 'pierre'));
    }

    /**
     * Gets the 'oc_platform.bigbrother.message_notificator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Bigbrother\MessageNotificator A OC\PlatformBundle\Bigbrother\MessageNotificator instance.
     */
    protected function getOcPlatform_Bigbrother_MessageNotificatorService()
    {
        return $this->services['oc_platform.bigbrother.message_notificator'] = new \OC\PlatformBundle\Bigbrother\MessageNotificator($this->get('swiftmailer.mailer.default'));
    }

    /**
     * Gets the 'oc_platform.doctrine_listener.application_creation' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\DoctrineListener\ApplicationCreationListener A OC\PlatformBundle\DoctrineListener\ApplicationCreationListener instance.
     */
    protected function getOcPlatform_DoctrineListener_ApplicationCreationService()
    {
        return $this->services['oc_platform.doctrine_listener.application_creation'] = new \OC\PlatformBundle\DoctrineListener\ApplicationCreationListener($this->get('oc_platform.email.application_mailer'));
    }

    /**
     * Gets the 'oc_platform.email.application_mailer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Email\ApplicationMailer A OC\PlatformBundle\Email\ApplicationMailer instance.
     */
    protected function getOcPlatform_Email_ApplicationMailerService()
    {
        return $this->services['oc_platform.email.application_mailer'] = new \OC\PlatformBundle\Email\ApplicationMailer($this->get('swiftmailer.mailer.default'));
    }

    /**
     * Gets the 'oc_platform.form.ckeditor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Form\CkeditorType A OC\PlatformBundle\Form\CkeditorType instance.
     */
    protected function getOcPlatform_Form_CkeditorService()
    {
        return $this->services['oc_platform.form.ckeditor'] = new \OC\PlatformBundle\Form\CkeditorType();
    }

    /**
     * Gets the 'oc_platform.purger.advert' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\PurgerAdvert\OCPurgerAdvert A OC\PlatformBundle\PurgerAdvert\OCPurgerAdvert instance.
     */
    protected function getOcPlatform_Purger_AdvertService()
    {
        return $this->services['oc_platform.purger.advert'] = new \OC\PlatformBundle\PurgerAdvert\OCPurgerAdvert($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'oc_platform.twig.antispam_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Twig\AntispamExtension A OC\PlatformBundle\Twig\AntispamExtension instance.
     */
    protected function getOcPlatform_Twig_AntispamExtensionService()
    {
        return $this->services['oc_platform.twig.antispam_extension'] = new \OC\PlatformBundle\Twig\AntispamExtension($this->get('oc_platform.antispam'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $j, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($j, '/platform'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        $l->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $l->addHandler($k);

        $m = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($j, array());
        $m->setOptions(array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $m->setProviderKey('main');

        $n = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $j, array(), $a);
    ...
    {
        return $this->services['web_profiler.debug_toolbar'] = new \Symfony\Bundle\WebProfilerBundle\EventListener\WebDebugToolbarListener($this->get('twig'), true, 2, 'bottom', $this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE), '^/(app(_[\\w]+)?\\.php/)?_wdt');
    }
